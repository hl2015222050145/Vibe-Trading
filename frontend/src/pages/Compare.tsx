...
const METRICS: MetricDef[] = [
  ...
  { key: "trade_count",            label: "交易数",               type: "int", higherIsBetter: true },
  { key: "max_consecutive_losses", label: "最大连亏",             type: "int", higherIsBetter: false },
  { key: "exposure_time",          label: "持仓暴露时间",         type: "pct", higherIsBetter: true },
    ...
    <div className="p-8 max-w-4xl space-y-6">
      ...
      {!leftData && !rightData && (
        <div className="text-center py-16 text-muted-foreground">
          ...
          <p className="text-sm">选择两个运行记录来对比指标。</p>
        </div>
      )}
    </div>
  );
